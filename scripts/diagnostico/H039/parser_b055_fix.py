...
# "LORENZETTI.", "MAQUEDA.", "ARGIBAY." matchean la heurística de sumario
# (mayúsculas + punto) pero son firma truncada por detectar_fin_real.
...
def linea_es_header_sumario(linea):
    ...
    if len(primera_palabra) < 5:
        return False
    # H039: descartar si la primera palabra es apellido de juez conocido
