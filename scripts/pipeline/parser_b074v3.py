...
def detectar_fin_real(lines, linea_inicio, linea_fin_catalogo,
    ...
    # ── B074v3: guarda posicional en fallback firma_actual ─────────────
    # Buscar primera RE_APERTURA dentro de [li, lfc] como lower-bound.
    # Si buscar_atras encuentra firma ANTES de esa apertura, rechazarla
    # (es del caso anterior) y reintentar con rango restringido.
    _primera_apertura = None
    for _j in range(li, lfc + 1):
