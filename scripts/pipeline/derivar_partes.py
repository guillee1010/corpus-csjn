...
RE_MARK_REC = re.compile(
    ...
    r"(.*?)(?=\bTraslados?\b|\bTribunal\b|\bProfesional|\bNorma\b|\Z)",
    re.S | re.M)
...
def _match_letrado_caratula(clause: str, caratula: str):
    ...
    demandado = re.split(r"\s+s/\s+", resto, 1)[0]
