...
**Estado:** pendiente de triage por ROI.
...
**Estado:** diseñado (esquema arriba). **APLICAR acoplado a la sesión de materia** (que regenera el CSV sí o sí) y documentar en el refresh CODEBOOK/Dataverse diferido — un ciclo, no dos.
**Referencias cruzadas:** M48 (sin_ancla 1102), M35/Dataverse, M16/explorador. H191.
...
**Estado del fix:** no diseñado.
**Referencias cruzadas:** B159 (contexto del destape), H052. H196. Sin ID histórico.
...
### B166 — Outcome leído del dispositivo de la DISIDENCIA (mayoría-vs-disidencia): el último performativo del bloque no es el del caso — FIX PARCIAL H203 (vocabulario) + **FIX (c) H205 (panel por evidencia de zonas)**; residual (b)/(d) ABIERTO
