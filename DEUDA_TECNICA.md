...
**Estado del fix:** no diseñado (frente nuevo).
...
**Referencias cruzadas:** M25 (le da el insumo de rol), HM-01 / SCDB, `csjn_editorial_indice_partes.csv`, patrón `derivar_materia`. H153. Sin ID histórico.
