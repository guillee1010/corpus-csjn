...
**Última actualización:** 2026-07-05 (H178 — **PASO 3 DE M39 EJECUTADO Y CERRADO (parser v23.2→v24.0): is_merit DERIVADO del gate del clasificador como FUENTE ÚNICA — divergencia M39 = 0 POR CONSTRUCCIÓN; instrumento D1 RETIRADO**. Gate de apertura reproducido exacto (divergencia 227 = 151+76 · is_merit 3010 · gate=si 2935 · orig 589 · nulidad 56; nota: corrige el «2950» de la constancia H177 — el valor sellado post-B143 es 2935). Micro-items: sección «Dónde está cada cosa» AÚN NO pegada en el skill de apertura (verificado leyendo el SKILL.md; acción de Guillermo vía UI, sigue pendiente) · decisión git: `git add -f` de los PoCs bimodales (poc_b143_guard H177 + poc_paso3_m39 H178) — los verificadores con candado son la evidencia de adjudicación, se versionan. **DISEÑO (gate #1, opción (i) = patrón B136 extendido corpus-wide):** is_merit sigue siendo columna del parser pero su fuente es el gate para TODO el corpus — el parser importa disposicion()+es_revision_fondo() con la llamada IDÉNTICA a derivar_recursos v0.6; branch originaria y MERIT_OUTCOMES retirados; GATEKEEP_OUTCOMES removido (código muerto preexistente, 0 usos — hallazgo H178). Razones verificadas en código contra la opción (ii)-migrar-al-deriver: B137/tipo_voto consume is_merit EN TIEMPO DE PARSEO (regla L1738, invocación L3680) · votos.csv lo denormaliza por voto · **build_m20 SÍ consume is_merit** (2 columnas: parser_es_revision_fondo + _ctx_is_merit — verificado en código, exigencia del prompt) · schema 39 columnas intacto · MAPA sin reestructura. La copia local de nulidad_concesion (pre-cascada B119, regex angosta pre-B140b) QUEDA: moldea outcome (eje legacy), ya no contamina is_merit; dedup → D3/M40. **PoC bimodal poc_paso3_m39 v0.2 ([CLEAN] en sandbox Y en disco, candado 1.15/0.6/23.2):** A1 identidad de insumos — gate recomputado con la llamada del deriver da 0 diffs vs la columna publicada (round-trip CSV neutro; cerraba el supuesto crítico del diseño); A2 flip-set == 227 ids EXACTOS == divergencia publicada; A3 31/31 anclas 1→0 adentro (9 B140b + 13 B143 + 9 aciertos-del-gate H172/H176); A4 330_p399 no-flip; A5 n300 ∩ flip-set = 8 (330_p1907, 330_p4592, 331_p2621, 332_p2625, 332_p2797, 338_p40, 344_p3394, 348_p92). El reporte por clase destapó COSTOS ACEPTADOS no previstos en el prompt, adjudicados y aprobados (~22 flips con valor conocido-equivocado o transitorio, todos con unidad sucesora): 9 FN-B139a 1→0 (todos en el flip-set, ninguno coincide-en-error) · 4 residuales B138 0→1 con los tomos COMPLETADOS por búsqueda de sufijo (330_p1205, 330_p4891, 331_p2621, 348_p747) · 3 originarias B135(c) 1→0 (329_p3403 Ferrari, 344_p3476, 348_p473 — fondo real, flip por miss de is_originaria, NO por el gate; AUTORREPARABLES al cerrar B135c vía la rama originaria del gate: el fix futuro queda de punto único) · 1 B139b (331_p100, ídem al cerrar B139b) · 4 truncados M21 (329_p4634, 330_p4129, 347_p474, 348_p355 — el pe truncado le esconde el verbo al gate; se recuperan con M21 F3) · 1 ADC/329_p5261 0→1 (FP conocido B140a). **CICLO COMPLETO:** check_regresion [FAIL] adjudicado contra contrato (SOLO is_merit_decision en casos y votos; textos/zonas/editorial byte-idénticos = parseo intacto) → golden re-congelado consciente con TOTALIDAD demostrada (git diff --stat: casos EXACTAMENTE 227 filas, votos EXACTAMENTE 1078) → parser v24.0 corrido A PRODUCCIÓN → check_regresion [CLEAN] 5/5 → re-derivados los 4 derivers (epilogo/partes/materia/recursos: hashes SIN cambio — 0 ripple oculto; derivar_partes lee el is_merit nuevo solo para su summary en pantalla, «universo SCDB: 2935») → clave n300 regenerada (8 filas cambiaron = candado byte-idéntico RETIRADO CON D1; **desviación consciente del paso 2.2 del skill de cierre**: el blind 0,930 describe el eje viejo, la re-validación comprometida del eje unificado es M43) → PoC POST [CLEAN] (P1 divergencia 0+0 · P1b recursos re-derivado 0 diffs · P2 is_merit=2935 · 31/31 anclas en 0 · 330_p399 en 1) → manifest re-sellado (casos dc3830dcef82 == golden, votos 8e320b59aea1 == golden, 5 CSV v24.0). **Dato fino (diff_votos_h178 v0.1, golden viejo vía git show):** flips reales de tipo_voto_sep = **6** (dentro de la cota 15+2): 4 D→indeterminado en casos 1→0 (Lorenzetti 332_p1769 · Highton 333_p1279 · Rosenkrantz 341_p1924 Blanco [FN-B139a documentado] · Rosenkrantz 342_p411) + 2 indeterminado→D en 0→1 (Rosenkrantz 341_p648 · Rosenkrantz 342_p1524 Deutsche Rück [acierto-del-gate B138 → mejora genuina]); fragmenta_ratio/punto_divergencia acopladas 6/6; NINGUNA otra columna; filas tocadas 1078 exactas. **RETIRO DE D1:** trayectoria completa 234→219→208→216→227→**0**, cada movimiento adjudicado; límite documentado: las clases coincide-en-error (B142, B143 pre-fix, v1.14/impugnación) son lo que la divergencia nunca vio; sucesor del instrumento: M43. + Corrección de constancia: schema real de csjn_casos.csv = **39 columnas** (las menciones «40» de H148/H169 eran erróneas; historial intacto, corrección registrada en el changelog v24.0). **Lecciones ops H178:** (1) placeholder no-ejecutable (`<ruta-de-descarga>`) en hoja de ruta PowerShell → ParserError, el paso se salteó y la secuencia siguió con el parser viejo; la red que lo detectó fue el Select-String de versión post-instalación — las hojas de ruta van SIN placeholders (path real o Get-ChildItem previo); (2) `check_regresion --make-golden` corre el parser a TEMP y congela el golden pero NO refresca producción — el ciclo exige corrida explícita del parser a output\parser\ después del golden; lo detectó el PoC POST por hashes (golden ≠ manifest en casos/votos, con textos/zonas/editorial iguales — el trío sin-cambio como testigo). PENDIENTE H179: **M43** (re-κ ciego del eje unificado — SIGUIENTE unidad, pre-Dataverse; incluye κ de es_de_fondo) · B139b (8 lecturas — recupera 331_p100) · B135(c) (señal compuesta — recupera las 3 originarias del costo) · M21 F3 (recupera los 4 truncados) · audit B137 DESBLOQUEADO (universo definido: is_merit unificado 2935) · nota de semántica de is_merit en CODEBOOK para v2 Dataverse.)

**Anterior:** 2026-07-05 (H177 — **B143 CERRADO (clasificador v1.14→v1.15): guard nulidad-de-actuaciones en el gate, 16 lecturas adjudicadas, 15 FP si→no + 1 acierto (330_p399)**. Gate de apertura reproducido exacto (divergencia 216 · is_merit 3010 · gate=si 2950 · orig 589). Decisión de orden del punto 0: **(a)** — adjudicar B143 ANTES del paso 3 (los 16 estaban sentados del lado gate; el paso 3 los habría consagrado como canon Y habría flipeado 347_p327/348_p1152 de is_merit=0→1, fabricando 2 errores nuevos lado parser). Prerequisito verificado: **solapamiento B143 ∩ gold n300 = 0** (el guard no re-mapea codificación humana; κ-gate 0,946 intacto). Corrección al diagnóstico H176: los 16 NO eran todos coincide-en-error — eran **14 invisibles (is_merit=1) + 2 ya divergentes** (347_p327 outcome=abstracto, 348_p1152 outcome=otro, ambos is_merit=0, dentro de los 78 parser-no/gate-si). Superficie del alt corpus-wide = 17 (el 17º es 333_p405, disp=revoca con señal de absolución — fuera del guard por construcción vía ancla disp==nulidad). Adjudicación por familias (16 extraídas a `scripts/diagnostico/H177/`, leídas contra el `.md`, criterio confirmado por Guillermo caso a caso): 6 in-forma-pauperis/asistencia ineficaz (329_p1794, 330_p487, 330_p4925, 330_p5052 [Domínguez: vicio arranca «desde la sentencia» pero es asistencia ineficaz en la vía recursiva, retrotrae — la condena no se sustituye], 333_p1671, 339_p656) · 4 juzgado incompetente/avocación (330_p1169, 334_p1458, 337_p97, 345_p191) · 1 inexistencia de «caso» art. 116 (332_p1823 PROCURAR — sin controversia [litigio fabricado: actor y demandados pedían ratificar el decreto] = umbral tipo abstracto, coherente con in-limine B141 y «falta de acción» de EXCEP) · 4 retrotraídos por vicio de trámite (344_p163 traslado, 344_p1259 notificación, 347_p327 ministerio pupilar, 348_p1152 tercero impedido) = **15 procesales** + 330_p399 (López: «nulidad y SE ABSUELVE», art. 16 2ª parte = sustitutiva con absolución, fondo — gate=si correcto). **Guard v1.15** (patrón B119/B131, verbo intacto): `disp=="nulidad" ∧ RE_NULIDAD_ACTUADO ∧ ¬RE_ABSOLUCION → no` (RE_NULIDAD_ACTUADO verbatim del alt 1º de DISP, dedup pendiente como RE_NULIDAD_CONCESION; co-ocurrencia alt∩absolución corpus-wide = solo {399, 405}). + fix docstring L6 (path build_m20 → scripts/validacion). Métricas: gate=si 2950→**2935** (−15) · divergencia 216→**227** (+13 coincide-en-error EXPUESTOS lado parser [residuo para el paso 3, mismo estatus que los 9 de B140b], −2 que salen [327/1152]) · is_merit 3010 · disposicion=nulidad 56 · parser **0 ripple** → check_regresion [CLEAN] SIN re-golden · clave n300 byte-idéntica (build_m20 v1.15, ausente de git status) → blind 0,930 vigente · manifest [CLEAN] 64 · PoC bimodal `scripts/diagnostico/H177/poc_b143_guard.py` PRE+POST verdes con candado de versión (OJO: `scripts/diagnostico/H177/` está en .gitignore → PoC untracked; decidir si versionar con `git add -f`). Hallazgo git: **H176 estaba sin commitear** (HEAD era el fix de H175) — resuelto con 2 commits separados (H176: gemelos+golden; H177: v1.15+recursos+manifest) preservando trazabilidad H-código→commit. **Lecciones ops H177:** (1) hojas de ruta PowerShell van con `$ErrorActionPreference = 'Stop'` (fail-fast; los Copy-Item fallidos no deben silenciarse — acá benigno porque los archivos ya estaban instalados y el candado de versión del PoC abortó limpio, pero el patrón por defecto de PS sigue de largo); (2) micro-item de apertura cerrado: skill apertura SIN paths stale (solo nombra detectar_paginas/extraer_caso sin ruta, ambos verificados en disco) + sección nueva propuesta «Dónde está cada cosa» que apunta a **MAPA.md (raíz, verificado jun-2026)** como fuente única del DAG en vez de duplicar paths; (3) discrepancia menor anotada: docstring del parser dice «40 columnas» pero csjn_casos.csv tiene **39** — corregir en el bump del parser del paso 3. PENDIENTE H178: **paso 3 de M39** (is_merit derivado del clasificador como fuente única, sobre gate ya limpio de B143; absorbe M2A/M3/M4 + 9 de B140b + ~15 aciertos-del-gate H172/H176 + 13 expuestos hoy; verificar si build_m20 consume is_merit — no asumir; retiro documentado del instrumento D1) · B139b (8 lecturas) · M43 (re-κ post-paso-3) · B139a diferido (no relitigar sin testigo nuevo).)
...
### B139 — FN de `disposicion()`: verbo de fondo con objeto MATERIAL, y «rechaza la demanda» en sede recursiva (art. 16 in fine ley 48) — RE-ESTRATIFICADO Y DIFERIDO-FUNDADO H176 (superficie originaria CERRADA v1.14)
...
**Referencias cruzadas:** M39 (M2B/M2C), B119/B131 (patrón guard), M19 (blind 0,930), `clasificador_via` (insumo para sub-causa b). H170. Sin ID histórico.
...
### B143 — FP latente del gate: «nulidad de todo lo actuado» (nulidad DE ACTUACIONES) cuenta como fondo vía el alt window-free de DISP — CERRADO H177
...
### M42 — Orquestador del pipeline: script único que corra la cadena completa en orden
...
**Estado del fix:** no diseñado (esbozo).
**Referencias cruzadas:** M38 (enforcement de gates, mismo espíritu), M41 (schema), `check_regresion --make-golden`, `generar_manifiesto`. H174. Sin ID histórico.
