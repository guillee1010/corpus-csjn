...
### B148 — Detector de firma sobre-extiende: cuerpo/dictamen/cabeza denso en nombres etiquetado como `firma`
...
**Estado de verificación:** `confirmado_caso_testigo` (2 testigos leídos; cardinalidad no aislada del resto de BUG-2). **Evidencia nueva H192:** 330_p3801 — firma REAL de mayoría (con calificadores) etiquetada pre-dispositivo en el pool B148 porque el dispositivo de su voto no fue detectado; adjudicada como FP-del-pool-B148 / TP-de-B149 en `dump_b148_tramos.md`.
...
**Diagnóstico / evidencia:** `confirmado_caso_testigo` (338_p1433, diff alineado H192). Cardinalidad = corpus-wide por construcción si se confirma en código.
