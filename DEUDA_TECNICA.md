...
### M39 — Eje de mérito bicapa divergente: `is_merit` ⟺ `es_revision_fondo` (234 mismatches, taxonomía M1-M5 cerrada)
...
**Estado del fix:** no diseñado (sesión propia; atar al hito de publicación, no a un H suelto).
