...
### B115 — Merge de fallos por hueco en índice de partes (familia B009)
...
**Referencias cruzadas:** H108. Familia B009 (casos perdidos; mecanismo distinto del B009 original = tomos 331-334). B077 (fronteras de caso). Downstream: los 3 FP de `es_queja` (332_p1960, 343_p1987, 331_p856) caen solos al corregir esto. Sin ID histórico.
