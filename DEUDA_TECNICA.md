...
### B109 — Sobre-trigger `inadmisible_280` / `inadmisible_acordada_4` en outcome de quejas desestimadas

**Componente:** parser (`classify_outcome`, 280/Acordada 4).
**Origen / fuente del diagnóstico:** H100 (titular M19).
**Causa raíz:** en quejas donde el REX es inadmisible (art.280 / Acordada 4/2007) y la disposición de la queja es `desestima`, el parser pone `inadmisible_280`/`inadmisible_acordada_4` en `outcome`. La convención de codificación reserva `outcome` para la disposición de la queja (`desestima`) y registra el 280/ac4 en `causa_inadmisibilidad`.
**Diagnóstico / evidencia:** 12 casos cod `desestima` vs parser inadmisible_280/ac4; precision `inadmisible_280` 14%, `inadmisible_acordada_4` 0%. Casos: 329_p4902, 330_p2445, 330_p5131, 333_p1235, 339_p1048, 339_p597, 341_p127, 341_p1649, 342_p1483, 344_p2955, 345_p1421, 345_p670. Es la recalibración 280/art.4 ya anticipada post-B010.
**Estado de verificación:** `confirmado_cuantificado` (Marco A).
**Validador propuesto:** decidir taxonomía outcome-de-queja vs causa; si se mantiene, separar la señal 280/ac4 a `causa_inadmisibilidad` y dejar `outcome=desestima`. PoC A/B; cascada.
**Estado del fix:** no diseñado.
**Referencias cruzadas:** H100. M19. B092 (gate `causa`). Frente 280. Sin ID histórico.
