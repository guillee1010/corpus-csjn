...
### B113 — `Declarar abstracta` (infinitivo) cae a `otro` en vez de `abstracto`

**Componente:** parser (`classify_outcome`, pattern de `abstracto`).
...
**Causa raíz:** el pattern de `abstracto` (`inoficioso` | `abstracto` | `se declara abstracta?`) no cubre la forma infinitiva «Declarar abstracta/o la cuestión/pretensión».
**Diagnóstico / evidencia:** 12 casos en `otro`: 329_p40, 329_p1853, 329_p1898, 329_p2293, 329_p2733, 329_p4054, 329_p4370, 330_p3893, 331_p322, 337_p1439, 344_p1230, 344_p2020.
**Estado de verificación:** `confirmado_cuantificado` (corpus entero).
**Validador propuesto:** alternativa `declarar (la )?(cuestión|pretensión )?abstract[oa]` al pattern de abstracto; PoC A/B sobre texto idéntico; check_regresion. Cambio atómico aparte (no mezclar con B112).
**Estado del fix:** no diseñado (teed up post-B112).
**Referencias cruzadas:** H104. B112 (lo expuso). Sin ID histórico.
