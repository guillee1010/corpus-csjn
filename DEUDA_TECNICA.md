...
**Última actualización:** 2026-06-03 (H112). Frente B / materia capa 1 implementada (`derivar_materia.py` v1.0 → sidecar `csjn_casos_materia.csv`, 6º output canónico; cobertura capa1 2474/5697 = 43,4%); `generar_manifiesto.py` v1.2 (`--verify` [CLEAN] 55); saldada la deuda de procedencia de H111; **B117 NUEVO** (zona epilogo absorbe la cola del considerando, testigo 329_p595).
