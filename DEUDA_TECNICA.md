...
### B124 — `por_ello` mislocalizado: `_barrer` ancla el PRIMER "Por ello", no el del dispositivo
...
**Estado del fix:** no diseñado. **Independiente de B124** (toca cualquier firma con nombre cortado por línea, no solo bajo regla P); la regla P apenas lo EXPONE al mover el arranque del `collect_firma_lines`.
