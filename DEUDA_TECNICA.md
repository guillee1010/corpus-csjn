...
**Estado de verificación:** `confirmado_caso_testigo` (1 caso). Generalidad NO verificada — puede ser común a otros fallos de considerando largo / página compartida.
