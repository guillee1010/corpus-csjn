...
### B153 — Conjueces no reconocidos en la firma: paneles subcontados
...
**Estado del fix:** no diseñado. Opciones: lista extendida de conjueces por período (dato curado, análogo M46) o patrón posicional «— Nombre (conjuez)». **Reparación parcial de rebote (H190):** el guard continuación-de-wrap de parser v27.1 protege el FRAGMENTO wrapeado de estas firmas del retroceso de frontera (329_p4506 ya no pierde la línea), pero el reconocimiento del conjuez para votos/panel sigue abierto. Encolado; relevante para el eje de votos de la tesis (H5).
