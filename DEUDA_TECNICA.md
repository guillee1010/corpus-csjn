...
### B149 — Detector de dispositivo se pierde «Que por lo expuesto… se hace lugar/resuelve»
...
**Estado del fix:** no diseñado. Acotado a `detectar_apertura_dispositivo`, sin tocar la máquina de estados de Pasada 2. MAJOR igual (mueve borde de zona). Requiere leer `detectar_apertura_dispositivo` (no leída aún).
