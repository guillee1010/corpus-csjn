...
| B131 | `nulidad del auto de concesión` puede clasificarse como fondo (OBJ de `clasificador_disposicion` incluye `auto`) | abierto; hipótesis H141 (taxonomía M26); se resuelve en M26 Fase 2 |
