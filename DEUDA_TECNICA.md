...
### B110 — `es_queja` sub-detectado (falsos negativos)

**Componente:** parser (detección de recurso de hecho / queja).
**Origen / fuente del diagnóstico:** H100 (titular M19).
**Causa raíz:** el parser no marca `es_queja=1` en ~18% de las quejas reales; cuando marca 1 acierta (precision 96,9%) pero pierde recall (82,3%). Arrastra `queja_resultado` vacío en 13 de los 20 FN.
**Diagnóstico / evidencia:** 20 FN (cod=1, parser=0) en el Marco A: 329_p1487, 329_p4094, 329_p4717, 329_p5789, 330_p1907, 330_p238, 330_p2445, 330_p4632, 330_p5010, 330_p5197, 332_p2625, 337_p329, 337_p373, 338_p40, 343_p412, 344_p2393, 345_p583, 348_p1378, 348_p1717, 348_p92.
**Estado de verificación:** `confirmado_cuantificado` (Marco A).
**Validador propuesto:** revisar el detector de queja contra los 20 FN; varios solapan con B105 (frente A): 332_p2625, 343_p412, 344_p2393, 345_p583.
**Estado del fix:** no diseñado.
**Referencias cruzadas:** H100. M19. B105. Sin ID histórico.
