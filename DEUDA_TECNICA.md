...
### B107 — Cascada de `outcome` mal-clasifica negación y «excepción de incompetencia»
...
**Estado del fix:** no diseñado.
**Referencias cruzadas:** H098. M19. B091. Sin ID histórico.

### B108 — `competencia` (incompetencia originaria) cae a `outcome=otro`
...
**Estado del fix:** no diseñado.
**Referencias cruzadas:** H100. M19. B105/B107 (otras fugas a `otro` y de cascada). Frente D (is_originaria/competencia). Sin ID histórico.
