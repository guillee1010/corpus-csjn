...
**Diagnóstico / evidencia:** 3 testigos (n300): `330_p4592` → `rechaza` (rechazar-inf le gana a hacer-lugar + dejar sin efecto la sentencia); `338_p40` → `desestima` (se desestima la demanda tapa deja sin efecto la sentencia apelada); `344_p3394` → `desestima` (se desestima la queja tapa procedente + confirma la sentencia — el mixto queja+REX).
**Estado de verificación:** `confirmado_caso_testigo` (3/3, n300).
