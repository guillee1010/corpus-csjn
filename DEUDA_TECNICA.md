...
### B162 — `en_consecuencia` T1 argumental sin guard performativo: zona `dispositivo` sobre-extendida en votos
...
**Estado del fix:** no diseñado (camino especificado).
**Referencias cruzadas:** B067/H130/H194-A2 (patrón perf-gate, constancias madre), B159 (destape), constancia multivoto ~13 de H194 (posible solape de familia), M50 (las zonas infladas tocan wc_*). H196. Sin ID histórico.
...
**Estado:** pendiente (higiene; acoplar a otra unidad de parser, no ciclo propio).
**Referencias cruzadas:** M46, M40. H196.
