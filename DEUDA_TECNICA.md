...
**Estado del fix:** no diseñado. **`reenvía` NO es reportable hasta recodificar.**
**Referencias cruzadas:** M22 (reenvía desde dispositivo), M19 (κ/doble-codificación), `kappa_confiabilidad.py` (H139). H139. Sin ID histórico.
